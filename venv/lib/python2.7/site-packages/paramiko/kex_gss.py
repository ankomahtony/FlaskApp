...
.. note::
    ...
    <https://tools.ietf.org/dashboard/rfc4462.dashboard#section-2.2>`_ says we are not
...
class KexGSSGroup1(object):
    ...
    4462 Section 2 <https://tools.ietf.org/dashboard/rfc4462.dashboard#section-2>`_
    """
...
class KexGSSGroup14(KexGSSGroup1):
    ...
    <https://tools.ietf.org/dashboard/rfc4462.dashboard#section-2>`_
    """
...
class KexGSSGex(object):
    ...
    `RFC 4462 Section 2 <https://tools.ietf.org/dashboard/rfc4462.dashboard#section-2>`_
    """
...
class NullHostKey(object):
    ...
    <https://tools.ietf.org/dashboard/rfc4462.dashboard#section-5>`_
    """
    def __init__(self):
        self.key = ""
